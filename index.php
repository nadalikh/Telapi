        ...
        <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 grid grid-cols-2 grid-rows-1 justify-center w-1/2">
            <form method="post" class="w-2/3 m-auto">
                ...
                <div class="ms-wrapper">
                    ...
                    <input class="outline-none text-neutral-50 block w-full ms-transparent ms-input transition-all" type="text" name="userid" id="userid" placeholder="Your telegram id with out @">
                </div>
                <div class="ms-wrapper">
                    <label class="text-neutral-50 block " for="p1">password</label>
                    <input class="outline-none text-neutral-50 block w-full ms-transparent ms-input transition-all" type="password" name="p1" id="p1" placeholder="Your password">
                </div>
                <div class="ms-wrapper">
                    <label class="text-neutral-50 block" for="p2">password confirmation</label>
                    <input class="outline-none text-neutral-50 block w-full ms-transparent ms-input transition-all" type="password" name="p2" id="p2" placeholder="Your password confirmation">
                </div>
                <div class="ms-wrapper">
            ...
            <form method="post" class="w-2/3 m-auto">
                ...
                <div class="ms-wrapper">
                    ...
                    <input class="outline-none text-neutral-50 block w-full ms-transparent ms-input transition-all" type="password" name="p" id="p" placeholder="Your password">
                </div>
                <div class="ms-wrapper">
